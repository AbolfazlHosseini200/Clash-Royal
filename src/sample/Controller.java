...
public class Controller{
    ...
    private final Image pekaImage=new Image("/Photos/mini pekka_00000.png");
    private final Image babarImage=new Image("/Photos/barbarian_00000.png");
    private final Image wizardImage=new Image("/Photos/wizard_00000.png");
    private final Image infernoImage=new Image("/Photos/inferno_00000.png");
    private final Image giantImage=new Image("/Photos/giant_00000.png");
    private final Image arrowImage=new Image("/Photos/arrows_00000.png");
    private final Image archerImage=new Image("/Photos/archer_00000.png");
    private final Image valkyrieImage=new Image("/Photos/valkyrie_00000.png");
    private final Image rageImage=new Image("/Photos/rage_00000.png");
    private final Image canonImage=new Image("/Photos/canon_00000.png");
    private final Image fireBallImage=new Image("/Photos/fireball_00000.png");
    private final Image babyDragonImage=new Image("/Photos/baby dragon_00000.png");
    private final Image frame=new Image("/Photos/frame.png");
    @FXML
    private Button done;
    @FXML
